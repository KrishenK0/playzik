...
function reqSongInPlaylist(googleId, videoId, playlistId) {
    return new Promise((resolve, reject) => {
...
function reqSong(googleId, videoId) {
    return new Promise((resolve, reject) => {
        request.post(`https://music.youtube.com/youtubei/v1/player?alt=json&key=AIzaSyC9XL3ZjWddXya6X74dJoCTL-WEYFDNX30`)
            .set(ytheader)
            .set({ 'X-Goog-Visitor-Id': googleId })
...
function reqSuggestion(googleId, query) {
    return new Promise((resolve, reject) => {
...
function reqSearch(googleId, query) {
    return new Promise((resolve, reject) => {
...
function reqLyrics(googleId, browseId) {
    return new Promise((resolve, reject) => {
...
function reqRelated(googleId, browseId) {
    return new Promise((resolve, reject) => {
        request.post(`https://music.youtube.com/youtubei/v1/browse?alt=json&key=AIzaSyC9XL3ZjWddXya6X74dJoCTL-WEYFDNX30`)
            .set(ytheader)
            .set({ 'X-Goog-Visitor-Id': googleId })
